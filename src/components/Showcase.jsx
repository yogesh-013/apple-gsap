...
const Showcase = () => {
    ...
    return (
        <section id="showcase">
            <div className="media">
                <video className="showcase-video" src="/videos/game.mp4" loop muted autoPlay playsInline />
                <div className="mask">
<img className="showcase-img" src="/mask-logo.svg" alt="" />
                </div>
            </div>
            ...
            <div className="content">
                <div className="wrapper">
                    <div className="lg:max-w-md">
                        <h2 className='showcase-h2'>Rocket Chip</h2>
                    ...
                    <div className="max-w-3xs space-y-14">
                        <div className="space-y-2">
                            <p>Up to</p>
                            <h3 className="showcase-h3">4x faster</h3>
                            <p>pro rendering performance than M2</p>
                        </div>
                        <div className="space-y-2">
                            <p>Up to</p>
                            <h3 className="showcase-h3">1.5x faster</h3>
